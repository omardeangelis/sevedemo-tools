...
Pipeline giornaliera che estrae, arricchisce e seleziona 40 contatti LinkedIn per cold-email (tool #1 di SeVedemo). Pagine narrative migrate da `docs/` il 2026-06-12; l'ingest spec-driven in `flows/`/`concepts/` è in corso (10 flows, 11 concepts).
...
| lead-engine | [[specs/lead-engine/influencer-post-respondents/SPEC]] | Implemented |
...
- [[specs/lead-engine/influencer-post-respondents/REPORT|lead-engine/influencer-post-respondents]] — spec · SHIP (1 BLOCKER risolto+ri-verificato) · critical · 2026-06-17
