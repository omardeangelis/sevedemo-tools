...
- MUST use `$swarm-plan`
- MUST use `$tdd`
- your code-search tool (or Context7 for library docs / web search) provides source context for installed or external packages
...
- Keep the canonical backlog model aligned with your backlog / issue tracker.
